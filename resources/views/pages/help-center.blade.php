...
<div class="max-w-6xl mx-auto py-12 px-6 lg:px-8">
    <div class="mb-16 text-center">
        <h1 class="text-4xl font-extrabold text-slate-900 tracking-tight sm:text-5xl mb-4">{{ __('messages.hc_title') }}</h1>
        <p class="text-xl text-slate-500 font-light max-w-2xl mx-auto">{{ __('messages.hc_subtitle') }}</p>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <aside class="lg:col-span-3">
            <nav class="sticky top-24 space-y-2">
                <p class="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] px-4 mb-4">{{ __('messages.hc_nav') }}</p>
        ...
        <div class="lg:col-span-9 space-y-20">
            ...
            <section id="primeros-pasos" class="scroll-mt-28">
                <div class="flex items-center gap-4 mb-8">
                    ...
                    <h2 class="text-2xl font-bold text-slate-900 tracking-tight">{{ __('messages.hc_step1') }}</h2>
                </div>
                <div class="grid md:grid-cols-2 gap-6">
                    <div class="bg-white p-6 rounded-2xl border border-blue-50 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <p class="text-sm text-slate-500 leading-relaxed font-medium">{{ __('messages.hc_access_desc') }}</p>
                    </div>
                    <div class="bg-white p-6 rounded-2xl border border-blue-50 shadow-sm hover:shadow-md transition-shadow">
                        <h3 class="font-bold text-slate-800 mb-3 flex items-center gap-2">
                        ...
                        <p class="text-sm text-slate-500 leading-relaxed font-medium">{{ __('messages.hc_roles_desc') }}</p>
                    </div>
                </div>
            </section>
            ...
            <section id="gestion-eventos" class="scroll-mt-28">
                <div class="flex items-center gap-4 mb-8">
                    ...
                    <h2 class="text-2xl font-bold text-slate-900 tracking-tight">{{ __('messages.hc_op_title') }}</h2>
                </div>
                <div class="space-y-4">
            ...
            <section id="soporte-tecnico" class="scroll-mt-28">
                <div class="flex items-center gap-4 mb-8">
                    ...
                    <h2 class="text-2xl font-bold text-slate-900 tracking-tight">{{ __('messages.hc_step3') }}</h2>
                </div>
            ...
            <section id="seguridad" class="scroll-mt-28">
                <div class="flex items-center gap-4 mb-8">
                    ...
                    <h2 class="text-2xl font-bold text-slate-900 tracking-tight">{{ __('messages.hc_step4') }}</h2>
                </div>
                <div class="bg-white rounded-3xl border border-blue-50 p-8 shadow-sm">
                    <div class="grid md:grid-cols-2 gap-12">
                        <div class="space-y-6">
                            <div>
                                <h4 class="font-bold text-slate-800 mb-2 uppercase text-[11px] tracking-widest text-blue-600">{{ __('messages.hc_sec_session') }}</h4>
                                <p class="text-sm text-slate-500 font-medium leading-relaxed">{{ __('messages.hc_sec_session_desc') }}</p>
                            </div>
                            <div>
                                <h4 class="font-bold text-slate-800 mb-2 uppercase text-[11px] tracking-widest text-blue-600">{{ __('messages.hc_sec_audit') }}</h4>
                                <p class="text-sm text-slate-500 font-medium leading-relaxed">{{ __('messages.hc_sec_audit_desc') }}</p>
                            </div>
                        </div>
                        <div class="bg-slate-50 rounded-2xl p-6 border border-slate-100">
                            <h4 class="font-bold text-slate-800 mb-4 text-sm">{{ __('messages.hc_sec_tips') }}</h4>
                            <ul class="space-y-4">
                                <li class="flex items-start gap-3">
                                    ...
                                    <span class="text-xs font-semibold text-slate-600">{{ __('messages.hc_tip1') }}</span>
                                </li>
                                <li class="flex items-start gap-3">
                                    ...
                                    <span class="text-xs font-semibold text-slate-600">{{ __('messages.hc_tip2') }}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
